...
# Setup script for adding new badminton racket images and equipment

echo "Setting up new badminton racket equipment..."

# Create the equipment images directory if it doesn't exist
mkdir -p frontend/public/assets/img/equipments
